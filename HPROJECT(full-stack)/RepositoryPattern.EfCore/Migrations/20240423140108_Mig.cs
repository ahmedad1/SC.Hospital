        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysOfTheWork = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql(@$"
                                ...
                                values('Admin','Admin','schospital.admin','schospital.admin@gmail.com','{BCrypt.Net.BCrypt.EnhancedHashPassword("changeme")}','Male','1999-02-02',1)
                            ");
        }
