        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleOfDoctor_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            values('Admin','Admin','schospital.admin','schospital.admin@gmail.com','{BCrypt.Net.BCrypt.EnhancedHashPassword("changeme")}','{nameof(Gender.Male)}','1999-02-01',1)
            ");
        }
